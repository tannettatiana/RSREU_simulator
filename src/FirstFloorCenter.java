...
public class FirstFloorCenter extends BasicGameState {

    private TiledMap map;

    public FirstFloorCenter(int state) {
    ...
    public void init(GameContainer container, StateBasedGame stateBasedGame) throws SlickException {
        ...
        map = new TiledMap("data/FirstFloorCenter.tmx");
    }

    @Override
    public void render(GameContainer gameContainer, StateBasedGame stateBasedGame, Graphics g) throws SlickException {
        Game game = (Game)stateBasedGame;
        map.render(game.x, game.y, 0, 0, 140, 40);  //отрисовка карты с заданных координат
    ...
    public void update(GameContainer container, StateBasedGame stateBasedGame, int delta) throws SlickException {
        ...
        game.checkStairs(0, absMapX, absMapY, 3, 2, game.XYSecondFloor, stateBasedGame, map);
        game.checkStairs(1, absMapX, absMapY, 3, 3, game.XYSecondFloor, stateBasedGame, map);
        game.checkStairs(2, absMapX, absMapY, 3, 4, game.XYSecondFloor, stateBasedGame, map);
